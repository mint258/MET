...
def main():
    ...
    # 定义各层参数及标签
    trainable_parameters = [7016705, 5160707, 4143363,
                            3126019, 2108675, 1091331,
                            1025539, 959747, 893955, 861059]
    tick_labels = ["Embedding", "EGNN1", "EGNN2", "EGNN3", "EGNN4",
                   "Linear1",  "Linear2",  "Linear3",
                   "Linear4",  "Transformer"]
    bg_colors = {
        "Embedding": "#f6f6bc",
        "EGNN1": "#afcf78", "EGNN2": "#afcf78",
        "EGNN3": "#afcf78", "EGNN4": "#afcf78",
        "Linear1": "#eab375",
        "Linear2": "#eab375",
        "Linear3": "#eab375",
        "Linear4": "#eab375",
