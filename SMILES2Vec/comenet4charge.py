...
class ComENetAutoEncoder(nn.Module):
    ...
    def reset_parameters(self):
        ...
        for output_layer in self.output_layers_z:
            initialize_weights(output_layer.weight, method='glorot')
    ...
    def forward(self, data):
        ...
        for transformer, output_layer in zip(self.transformer_decoders_z, self.output_layers_z):
            ...
            # 通过输出层得到最终预测
            output = output_layer(transformer_output)  # [total_valid_atoms, 1]
